 ...
 */
class Gaia3DPointSource2 extends Source {
    /**
    ...
    constructor(source) {
        ...
        this.isGaia3DPointSource2 = true;
        ...
        console.log("Gaia3DPointSource2");
    }

    urlFromExtent(tile) {
        console.log("urlFromExtent GAIA " + tile);
...
export default Gaia3DPointSource2;
