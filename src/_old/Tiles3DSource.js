...
/**
 * @classdesc
 * Tile3DSource are object containing informations on how to fetch vector
 * tiles resources.
 *
 ...
 */
class Tiles3DSource extends TMSSource {
    /**
     ...
     */
    constructor(source) {
        source.format = 'application/json';
